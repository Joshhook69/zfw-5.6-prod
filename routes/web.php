...
Route::group(['before' => 'auth'], function(){
    ...
    Route::get('/ids/dfw-south', 'IDSController@showDFWsouth');
    Route::get('/ids/dfw-north', 'IDSController@showDFWnorth');
    Route::get('/ids/d10esat', 'IDSController@showD10ESAT');
    Route::get('/ids/d10wsat', 'IDSController@showD10WSAT');
    Route::get('/ids/d10dep', 'IDSController@showD10dep');
    Route::get('/ids/d10stars', 'IDSController@showD10stars');
    ...
    Route::group(['before' => 'mentor'], function(){
        ...
        Route::post('/admin/mentor/requests/{id}/edit', 'MentorController@editSession');
