    ...
    <div class="about-us-two">
        <div class="team-two">
            <div class="block-heading-two">
                <h3><span>Air Traffic Manager</span> - <a href="mailto:atm@zfwartcc.net"><i class="fa fa-envelope"></i></a></h3>
            </div>
        ...
        <div class="team-two">
            <div class="block-heading-two">
                <h3><span>Deputy Air Traffic Manager</span> - <a href="mailto:datm@zfwartcc.net"><i class="fa fa-envelope"></i></a></h3>
            </div>
        ...
        <div class="team-two">
            <div class="block-heading-two">
                <h3><span>Training Administrator</span> - <a href="mailto:ta@zfwartcc.net"><i class="fa fa-envelope"></i></a></h3>
            </div>
        ...
        @if(count($Roles->filter(rolepos('ATA'))->first()->users))if(count($Roles->filter(rolepos('ATA'))->first()->users))
        <div class="team-two">
            <div class="block-heading-two">
                <h3><span>Assistant Training Administrator</span> - <a href="mailto:ata@zfwartcc.net"><i class="fa fa-envelope"></i></a></h3>
            </div>
        ...
        <div class="team-two">
            <div class="block-heading-two">
                <h3><span>Webmaster</span> - <a href="mailto:wm@zfwartcc.net"><i class="fa fa-envelope"></i></a></h3>
            </div>
        ...
        <div class="team-two">
            <div class="block-heading-two">
                <h3><span>Assistant Webmaster</span> - <a href="mailto:awm@zfwartcc.net"><i class="fa fa-envelope"></i></a></h3>
            </div>
        ...
        <div class="team-two">
            <div class="block-heading-two">
                <h3><span>Events Coordinator</span> - <a href="mailto:ec@zfwartcc.net"><i class="fa fa-envelope"></i></a></h3>
            </div>
        ...
        <div class="team-two">
            <div class="block-heading-two">
                <h3><span>Assistant Events Coordinator</span> - <a href="mailto:aec@zfwartcc.net"><i class="fa fa-envelope"></i></a></h3>
            </div>
        ...
        <div class="team-two">
            <div class="block-heading-two">
                <h3><span>Facility Engineer</span> - <a href="mailto:fe@zfwartcc.net"><i class="fa fa-envelope"></i></a></h3>
            </div>
        ...
        <div class="team-two">
            <div class="block-heading-two">
                <h3><span>Assistant Facility Engineer</span> - <a href="mailto:afe@zfwartcc.net"><i class="fa fa-envelope"></i></a></h3>
            </div>
        ...
        <div class="team-two">
            <div class="block-heading-two">
                <h3><span>Instructors</span> - <a href="mailto:instructors@zfwartcc.net"><i class="fa fa-envelope"></i></a></h3>
            </div>
        ...
        <div class="team-two">
            <div class="block-heading-two">
                <h3><span>Mentors</span> - <a href="mailto:training@zfwartcc.net"><i class="fa fa-envelope"></i></a></h3>
            </div>
