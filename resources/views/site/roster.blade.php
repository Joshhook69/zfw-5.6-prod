                            ...
                            <table class="table table-condensed">
                                ...
                                <tbody>
                                    ...
                                    @endif
					                    ...
					                    @elseif($h->del_cert === "Minor Certified")<td bgcolor="#adffad">
                                        ...
                                        @elseif($h->gnd_cert === "Minor Certified")<td bgcolor="#adffad">
                                        ...
                                        @elseif($h->twr_cert === "Solo Certified")<td bgcolor="#b9a3ba">
                                        @elseif($h->twr_cert === "Minor Certified")<td bgcolor="#adffad">
                                        ...
                                        @elseif($h->app_cert === "Solo Certified")<td bgcolor="#b9a3ba">
                                        @elseif($h->app_cert === "Minor Certified")<td bgcolor="#adffad">
                            ...
                            <table class="table table-condensed">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        @elseif($v->del_cert === "Minor Certified")<td bgcolor="#adffad">
                                        ...
                                        @elseif($v->gnd_cert === "Minor Certified")<td bgcolor="#adffad">
                                        ...
                                        @elseif($v->twr_cert === "Solo Certified")<td bgcolor="#b9a3ba">
                                        @elseif($v->twr_cert === "Minor Certified")<td bgcolor="#adffad">
                                        ...
                                        @elseif($v->app_cert === "Solo Certified")<td bgcolor="#b9a3ba">
                                        @elseif($v->app_cert === "Minor Certified")<td bgcolor="#adffad">
