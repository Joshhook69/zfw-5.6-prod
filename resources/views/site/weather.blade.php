	  	...
	  	<div class="tab-content">
		    ...
		    <div id="nexrad" class="tab-pane fade-in">
		        ...
		        <div class="row">
			        <div class="col-sm-12">
			        	...
			        	<a onclick="window.open('http://radblast.wunderground.com/cgi-bin/radar/WUNIDS_map?station=FWS&brand=wui&num=1&delay=15&type=N0R&frame=0&scale=1.000&noclutter=0&showstorms=0&centerx=400&centery=240&showlabels=1', '_blank');">Click here</a>.
		    ...
		    <div id="satellite" class="tab-pane fade-in">
		        ...
		        <div class="row">
			        <div class="col-sm-6">
						...
						<img src="https://cdn.star.nesdis.noaa.gov/GOES16/ABI/SECTOR/sp/01/20182280337_GOES16-ABI-sp-01-1200x1200.jpg" width="100%">
						<br />
			        ...
			        <div class="col-sm-6">
			        	...
			        	<img src="https://cdn.star.nesdis.noaa.gov/GOES16/ABI/SECTOR/sp/03/20182280347_GOES16-ABI-sp-03-1200x1200.jpg" width="100%">
			        	<br />
		    ...
		    <div id="wind" class="tab-pane fade-in">
				...
				<div class="row">
			        <div class="col-sm-12">
			        	<b>Surface Data</b><br>
			        	<a onclick="window.open('https://aviationweather.gov/windtemp?gis=off', '_blank');">Click here</a>.
			        	<br />
