            ...
            <div class="col-sm-6">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <img src="https://flightaware.com/resources/airport/{{{$airport->iata}}}/APD/AIRPORT+DIAGRAM/png" width="100%">
                    </div>
                </div>
            </div>
            <div class="col-sm-6">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title">Live Information</h4>
                    </div>
                    <div class="panel-body">
                        {{{$weather->metar}}}
                        @if($weather->type == 'VFR')
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapse2">Standard Departures (SID)</a>
                                </h4>
                            </div>
