...
<div class="page-heading-two">
    ...
    <div class="container">
       {{ Form::open(['action' => ['RosterController@update', $User->id], 'method' => 'PUT']) }}
            ...
            <div class="col-sm-6">
			  ...
			  <div class="form-group maximum">
                {{Form::label('training_ma', 'Training Level:', ['class'=>'control-label'])}}
                {{Form::select('training_max', [
                      0 => 'None',
                      1 => 'Minor Ground',
                      2 => 'Major Ground',
                      3 => 'Minor Tower',
    ...
    <script>
    	$(document).ready(function(){
			...
			var toggleMentorForm = function(){
    			var mentorChecked = document.getElementById("training_max").value;
    			if (mentorChecked = "MTR") {
    				$(".form-group maximum").toggle(true);
    			} else {
    				$(".form-group maximum").toggle(false);
    			}
    		};
