                ...
                <div class="panel panel-default">
                    ...
                    <div id="collapse1" class="panel-collapse collapse">
                        <div class="panel-body">
                            ...
                            <p>The only ZFW airport to use a radar facility is Orlando International (KMCO). This is due to the number of parallel runways, and number of consecutive arrivals and departures by the hour.</p>
                        </div>
                    </div>
                </div>
            </section>
