            ...
            <section class="panel">
                <div class="panel panel-default">
                    ...
                    <div id="collapse2" class="panel-collapse collapse">
                        <div class="panel-body">
                            <p>Inform all departing IFR military turboprop/turbojet aircraft (except transport and cargo types) to change to departure control frequency with takeoff clearance.<br /><br /> <strong>PHRASEOLOGY-</strong><br /><br /> <em>Change to departure.</em> <br /><br /> If you issue takeoff clearance and forget to issue the Change to departure phraseology, do not instruct a military turboprop/turbojet aircraft (except transport and cargo types) to change frequencies below 2,500 AGL. Issue "When able, contact departure."<br /><br /> Military Transport and Cargo type aircraft may be switched like standard departures.<br /><br /> Military VFR aircraft will receive the "Frequency change approved" phraseology once clear of possible conflict and airborne.</p>
                        </div>
                    </div>
                </div>
            </section>
