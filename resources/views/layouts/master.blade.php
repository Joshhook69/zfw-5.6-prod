...
<head>
	...
	<meta name="description" content="VATSIM's Fort Worth ARTCC">
	<meta name="keywords" content="VATSIM,VATUSA,ZFW,Dallas,Oklahoma City,Waco,Fort Worth ARTCC,Virtual ATC,DFW, Dallas Fort-Worth">
	...
	<link rel="stylesheet" href="/assetbootstrs/css/ap-datetimepicker.min.css">
...
<body>
	...
	<div class="outer">
		<div class="header-2">
			<div class="container">
				<div class="row">
					<div class="col-md-3 col-md-offset-1" style="padding-top: 12px;">
					  <img src="{{ asset('assets/images/zfwlogo.png') }}" height="40" width="179">
					</div>
					<div class="col-md-8">
						<div class="navy">
							<ul>
								...
								@if(Auth::check())
									@if(Auth::user()->can('staff'))
										<li><a href="/forum/index.php?action=post;board=2.0">Add News</a></li>
									@endif
								@endif
									...
									<ul>
										...
										<li><a>Training</a>
											<ul>
												...
												<li><a href="https://www.vatusa.net/cbt" target = "_blank">Training Material</a></li>
	...
	<footer>
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<p class="pull-left"><a href="http://vatstar.com" target="_blank"><img src="/assets/images/vatstar.png" style="max-height: 50px"></a></p>
