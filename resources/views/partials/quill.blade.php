<link rel="stylesheet" href="/assets/css/quill.base.css" />
...
<div class="quill-wrapper">
	<div id="full-toolbar" class="toolbar ql-toolbar ql-snow">
		...
		<span class="ql-format-group">
			<span title="Text Color" class="ql-color ql-picker ql-color-picker">
				<span class="ql-picker-label" data-value="rgb(0, 0, 0)"></span>
				<span class="ql-picker-options">
					<span data-value="rgb(0, 0, 0)" class="ql-picker-item ql-selected ql-primary-color" style="background-color: rgb(0, 0, 0);"></span>
					...
					<span data-value="rgb(255, 255, 255)" class="ql-picker-item" style="background-color: rgb(255, 255, 255);"></span>
			...
			<select title="Text Color" class="ql-color" style="display: none;">
			...
			<span title="Background Color" class="ql-background ql-picker ql-color-picker">
				<span class="ql-picker-label" data-value="rgb(255, 255, 255)"></span>
				<span class="ql-picker-options">
			...
			<select title="Background Color" class="ql-background" style="display: none;">
	...
	<div id="full-editor" class="editor ql-container ql-snow" style="height: 250px"></div>
</div>

<script src="/assets/js/quill.min.js"></script>
<script>
	var hidden_input = $("#{{ $id }}");
	var editor = new Quill("#full-editor", {
		modules: {
	...
	editor.on('text-change', function(d) {
		hidden_input.val(editor.getHTML());
	});

	editor.setHTML(hidden_input.val());
