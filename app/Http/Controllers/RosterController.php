...
class RosterController extends \BaseController {
    ...
    public function store()
    {
        ...
        else
        {
            ...
            {
                $message->to(Input::get('email'))->subject('Welcome to vZFW');
                $message->cc('zfw-atm@vatusa.net');
                $message->cc('zfw-datm@vatusa.net');
            });
            ...
            exec('php /home/zfwartcc/test.zfwartcc.net/artisan zjx:forum');
    ...
    public function update($id)
    {
        ...
        if (Auth::user()->can('snrstaff'))
        {
            ...
            $User->max = Input::get('training_max');
    ...
    public function loginv2()
    {
        ...
        {
            $_SESSION['redirect'] = "https://zfwartcc.net";
            header("Location: https://login.vatusa.net/uls/v2/login?fac=ZFW");
            exit;
        }
        ...
        $jwk = json_decode('{"alg":"HS256","use":"sig","kty":"oct","k":"GsBRRAHrXMiNW195-jNtRUb6P6CXVNsQ2J7lhYJ10-UJ8USlACKexsngzfnz5nfOS24wTYNULga2KAag-1JbyQ"}', true);
        ...
        if($sig == $parts[2]) {
            ...
            if($token['aud'] != 'ZFW') {
                return Redirect::action('FrontController@showWelcome')->with('message', "Not issued for ZFW");
            }
            ...
            if($userstatuscheck) {
                if($userstatuscheck->status == 1) {
                    ...
                    require("/home/zfwartcc/zfwartcc.net/public/forum/smf_2_api.php");
