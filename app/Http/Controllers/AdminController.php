...
class AdminController extends BaseController {
    ...
    public function setController($id)
    {
        ...
        {
            $message->to($user->email)->subject('Welcome to ZFW');
        });
    ...
    public function setFormerController($id)
    {
        ...
        {
            $message->to($user->email)->subject('Removed From ZFW Roster');
        });
    ...
    public function saveVisit()
    {
        ...
        else
        {
            ...
            Mail::send('emails.pendingvrequests', ['request' => $request], function($message){
                ...
                $message->to('atm@zfwartcc.net', 'datm@zfwartcc.net');
                $message->subject('ZFW - New Visiting Request');
            });
