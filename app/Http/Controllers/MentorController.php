...
class MentorController extends BaseController {
	...
	public function showRequests()
	{
		...
		return View::make('admin.mentors.sessions')->with('sessions', $sessions)->with('Roles', $Roles);
	}
	...
	public function editSession($id)
	{
		...
		$session->save();
		$session->sendNewSessionEmail();
		return Redirect::action('MentorController@showRequests')->with('message', 'Session has been successfully edited');
	...
	//public function soloCert()
	//{
	//	return View::make('solo.blade.php');
	//}
